...
1. Analytic Skills: how can you tackle the problem, critical thinking and thought process
2. Coding Skills: programming language skill
3. Technical Skills: Time/Space complexity and check the interviewee if they are just memorizing
4. Communication Skills: Check the employee if they are fit to the team
...
file:///Users/allohani/Downloads/Firefox%20Downloads/cheatsheet-2.pdf
...
Any repetition, bottlenecks like O(N^2), or unnecessary work? Did you use all the information the interviewer gave you? Bottleneck is the part of the code with the biggest Big O. 
...
10. Start actually writing your code now. Keep in mind that the more you prepare and understand what you need to code, the better the whiteboard will go. 
...
Here is a trick: Comment in the code, the checks that you want to do... write the function, then tell the interviewer that you would write tests now to make your function fail (but you won't need to
...
How can performance be improved? Possibly: Ask the interviewer what was the most interesting solution you have seen to this problem.
...
The answer is usually a divide-and-conquer approach — perform distributed processing of the data and only read certain chunks of the input from disk into memory, write the output back to disk and
combine them later.
